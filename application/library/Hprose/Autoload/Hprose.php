...
require_once $dirname . '/../Future/functions.php';
require_once $dirname .'/../Promise/functions.php';
...
spl_autoload_register(function($className) {
    ...
    if ((strlen($className) > 6) && (strtolower(substr($className, 0, 6)) === "hprose")) {
        if ($className{6} === '\\') {
            ...
            include $rootdir . DIRECTORY_SEPARATOR . str_replace("\\", DIRECTORY_SEPARATOR, $className) . ".php";
        }
        else {
            // Deprecated
